<?php
function matyou_global($wp_customize)
{
    // Section
    $wp_customize->add_section('global_section', array(
        'title'      => __('Global', 'matyou'),
        'priority'   => 30,
    ));
    ...
    $wp_customize->add_control('body_font', array(
        'description' => __('All fonts are hosted locally. Consent according to the GDPR is not required for this theme (cookie banner).', 'matyou'),
        'label'      => __('Main text font', 'matyou'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'body_background_color', array(
        'label' => __('Background color', 'matyou'),
        'section' => 'global_section',
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'font_color', array(
        'label' => __('Font color', 'matyou'),
        'section' => 'global_section',
        'settings' => 'font_color'
    )));
}
add_action('customize_register', 'matyou_global');
