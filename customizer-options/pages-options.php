<?php
function matyou_custom_pages($wp_customize)
{
    // Section
    $wp_customize->add_section('custom_theme_pages', array(
        'title' => __('Pages', 'matyou'),
        'priority' => 30,
        'description' => __('Options for WordPress "Pages".', 'matyou'),
    ));
    ...
    $wp_customize->add_control('maximum_width_of_pages', array(
        ...
        'label' => __('Maximum width of pages', 'matyou'),
...
add_action('customize_register', 'matyou_custom_pages');
